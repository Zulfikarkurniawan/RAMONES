            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        include "koneksi.php";
                        koneksi_buka();
                        $dt_id = mysql_fetch_array(mysql_query("SELECT max(id) as maxKode FROM user"));
                        $id = $dt_id['maxKode'];
                        $id++;
                        $new_id = sprintf("%04s", $id);
                        ?>

                            <form action="simpan.user.php" method="post" name="form1" enctype="multipart/form-data" onmousemove="move(event)">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h6 class="m-0 font-weight-bold text-info">New Data User</h6>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class='box box-info'>                                       
                                            ...
                                            <button type="submit" class="btn btn-info btn-flat" name="submit"><i class="fa fa-save"></i> &nbsp;Simpan</button>
                                        </div>           
                                    </div>
