                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Edit and View Data Notes</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-3">
                                ...
                                <div class='box box-primary'>
                                    <div class="row">
                                        <div class="col-sm-8">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-flat" name="submit"><i class="fa fa-save"></i> &nbsp;Update</button> &nbsp;
