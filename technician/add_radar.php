                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Tambah Data Radar</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                <form action="tambah.php" method="post">
                                    ...
                                    <input type="text" name="lokasi" class="form-control form-control-sm" placeholder="" required>
                                    </div>
                                    <div class="form-group">
                                    <label for="" class="">Lattitude</label>
